...
//    api = new GracenoteWebAPI("9932800-6944FB99E90C816EE1F6338E5F16035E", "6944FB99E90C816EE1F6338E5F16035E");
        try {
...
//                    intent2.putExtra(SearchManager.QUERY, currSong.getTitle() + " "
//                            + currSong.getArtist());
    ...
    /* for song image */
        AsyncTask<Void, Void, Bitmap> artistImageTask = new AsyncTask<Void, Void, Bitmap>() {
            protected Bitmap doInBackground(Void... p) {
                ...
                //Find the URL using echinest API.
                url = null;
                Bitmap bm = null;
